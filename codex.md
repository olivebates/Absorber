...
- HUD: the top-left panel is a filtered color-by-weapon damage table with health/regeneration stats and, after the first skill unlock, cyan mana/regeneration stats. Compact resources appear bottom-left after discovery, the minimap is top-right, inventory/equipment remain bottom-right, and unlocked player/Asha skills occupy the bottom center.
